export default {
  TRX:
    'https://cdn2.iconfinder.com/data/icons/cryptocurrency-20/512/crypto-cryptocurrency-coin-digital-trading-16-512.png',
  USDC: 'https://www.centre.io/images/usdc/usdc-icon-86074d9d49.png',
  USDT:
    'http://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/256/Tether-USDT-icon.png',
  NEO:
    'https://cdn4.iconfinder.com/data/icons/crypto-currency-and-coin-2/256/neo_neocoin-512.png',
  ETH: 'https://cdn4.iconfinder.com/data/icons/cryptocoins/227/ETH-alt-512.png',
  XRP: 'https://cdn4.iconfinder.com/data/icons/cryptocoins/227/XRP-512.png',
  DASH:
